within Buildings.Experimental.Media.Examples;
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/Media/Examples/AirPTDecoupledTemperatureEnthalpyInversion.mos"
        "Simulate and plot"),
